...
import { getUserInfo, getUserTypeToDisplay, logOut } from '../services/registerAPI';
  ...
  return (
    ...
    >
      <Grid container justifyContent='center' alignItems='center'>
        ...
        />
        <Typography variant="h4" style={{color: 'var(--main-color)'}}>{getUserTypeToDisplay(user)}</Typography>
      </Grid>
      <List>
